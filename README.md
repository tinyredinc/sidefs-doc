...
# API ENDPOINT
ADMIN PANEL API - DOC [fs-admin-api.index.md](admin/fs-admin-api.index.md)
```
https://fs-admin-api.sideai.com
https://hk-fs-admin-api.sideai.com
```

PUBLIC API - DOC [fs-pub-api.index.md](public/fs-pub-api.index.md)
```
https://fs-pub-api.sideai.com
https://hk-fs-pub-api.sideai.com
```

PLATFORM API - DOC [fs-plt-api.index.md](platform/fs-plt-api.index.md)
```
https://fs-plt-api.sideai.com
https://hk-fs-plt-api.sideai.com
```

MEGATEAM API - DOC [fs-mt-api.index.md](megateam/fs-mt-api.index.md)
```
